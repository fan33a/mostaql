    ...
    <form action="{{ route('admin.projects.store') }}" method="POST">
        ...
        <div class="row">
            ...
            <div class="col-6 mb-3">
                ...
                <input class="form-control {{ $errors->has('name_en') ? 'is-invalid' : '' }}" type="text" name="name_en" placeholder="project name" value="{{ old('name_en') }}">
                @error('name_en')
            ...
            <div class="col-6 mb-3">
                ...
                <input class="form-control {{ $errors->has('name_ar') ? 'is-invalid' : '' }}" type="text" name="name_ar" placeholder="project name" value="{{ old('name_ar') }}">
                @error('name_ar')
                    <small class="invalid-feedback">{{ $message }}</small>
                @enderror
            </div>
            <div class="col-6 mb-3">
                ...
                <textarea class="desc" name="description_en">{{ old('description_en') }}</textarea>
            ...
            <div class="col-6 mb-3">
                ...
                <textarea class="desc" name="description_ar">{{ old('description_ar') }}</textarea>
